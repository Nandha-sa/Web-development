...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($stmt->execute()) {
        ...
        // Get the user ID from MySQL (optional: you can also get it from `insert_id` or `last_insert_id` method)
        ...
        $profileData = [
            ...
            'email' => $email,
            'username' => $username,
            'age' => null,  // You can add default values for other fields if you like
            'dob' => null,
            'contact' => null,
